...
const labels = JSON.parse(chartOrderStatistics.getAttribute('data-labels'));
const series = JSON.parse(chartOrderStatistics.getAttribute('data-series'));
...
const orderChartConfig = {
  ...
  labels: labels, // pakai variabel di sini
  series: series, // pakai variabel di sini
