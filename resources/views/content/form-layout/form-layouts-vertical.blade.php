...
<div class="card">
  <div class="d-flex justify-content-between align-items-center">
    <h5 class="card-header">Data CPMI</h5>
  </div>

  <div class="card-body demo-vertical-spacing demo-only-element">
    <form action="{{ route('form-layouts-vertical') }}" method="POST">
      @csrf

      <!-- Dropdown untuk pilih CPMI -->
      <div class="mb-3">
        <label for="cpmi_id" class="form-label">Pilih CPMI (Alternatif)</label>
    ...
    <div class="col-md-6 mb-3">
      <div class="card card-body">
        ...
        <select name="kriteria[{{ $kriteria->id }}]" class="form-select" required>
          ...
          @foreach(optional($kriteria->subkriteria) as $sub)
          <option value="{{ $sub->id }}">
