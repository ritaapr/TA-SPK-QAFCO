        ...
        <div class="col-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('data-cpmi-copy', ['page' => request('page')]) }}"
                        class="btn btn-sm btn-outline-secondary me-3" title="Kembali ke daftar"
                        style="font-size: 1.2rem;">&times;</a>

                </div>

                <div class="card-body demo-vertical-spacing demo-only-element">
                    <form class="row g-3" method="POST" action="{{ route('data-cpmi-copy.update', $cpmi->id) }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="namaCpmi" name="nama_cpmi"
                                    value="{{ old('nama_cpmi', $cpmi->nama_cpmi) }}" placeholder="Masukkan Nama" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="nik" name="nik"
                                    value="{{ old('nik', $cpmi->nik) }}" placeholder="Masukkan NIK" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="noHp" name="no_hp"
                                    value="{{ old('no_hp', $cpmi->no_hp) }}" placeholder="Masukkan No. Hp" required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input type="date" class="form-control" id="tglDaftar" name="tanggal_daftar"
                                    value="{{ old('tanggal_daftar', $cpmi->tanggal_daftar) }}" required />
                            </div>
                        </div>

                        <!-- Upload Foto Profil -->
                        <div class="mb-3 row">
                            <label for="fotoProfil" class="col-md-2 col-form-label">Upload Foto Profil (Opsional)</label>
                            <div class="col-md-10">
                                <input type="file" class="form-control" id="fotoProfil" name="foto_profil"
                                    accept=".jpg,.jpeg,.png" />
                                @if ($cpmi->foto_profil)
                                    <small>File lama:
                                        <a href="{{ asset('storage/' . $cpmi->foto_profil) }}" target="_blank">Lihat
                                            Foto</a>
                                    </small>
                                @endif
                            </div>
