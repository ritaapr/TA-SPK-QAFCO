  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body demo-vertical-spacing demo-only-element">
        <form class="row g-3" method="POST" action="{{ route('forms-kriteria-inputs.update', $kriteria->id) }}">
          @csrf
          @method('PUT')
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control" id="kodeKriteria" name="kode_kriteria" value="{{ old('kode_kriteria', $kriteria->kode_kriteria) }}" placeholder="Masukkan Kode Kriteria" required />
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" class="form-control" id="namaKriteria" name="nama_kriteria" value="{{ old('nama_kriteria', $kriteria->nama_kriteria) }}" placeholder="Masukkan Nama Kriteria" required />
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.01" min="0" max="1" class="form-control" id="bobot" name="bobot" value="{{ old('bobot', $kriteria->bobot) }}" placeholder="Masukkan Bobot (0 - 1)" required />
            </div>
          </div>
          ...
          <div class="text-end">
            ...
            <a href="{{ route('forms-kriteria-inputs.index') }}" class="btn btn-outline-secondary">Kembali</a>
          </div>
